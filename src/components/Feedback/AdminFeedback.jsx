...
const AdminFeedback = () => {
  ...
  const fetchFeedback = async () => {
    try {
      const response = await fetch("https://backend-brain1-beqb.onrender.com/get-feedback");
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await fetch(`https://backend-brain1-beqb.onrender.com/api/delete_feedback/${id}`, {
        method: "DELETE",
      });
