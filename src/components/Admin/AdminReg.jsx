...
const AdminReg = () => {
  ...
  const handleRegister = async (e) => {
    ...
    setLoading(true);
    try {
      const res = await fetch("https://backend-brain1-beqb.onrender.com/admin-register", {
        method: "POST",
  ...
  const handleVerifyOtp = async () => {
    ...
    setLoading(true);
    try {
      const res = await fetch("https://backend-brain1-beqb.onrender.com/verify-admin-otp", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
