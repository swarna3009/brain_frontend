...
const ManageContact = () => {
  ...
  const fetchMessages = async () => {
    try {
      const response = await fetch("https://backend-brain-2.onrender.com/admin/contacts");
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await fetch(`https://backend-brain-2.onrender.com/admin/contacts/${id}`, {
        method: "DELETE",
      });
